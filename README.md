...
[Discord-DL](https://github.com/Yakabuff/discord-dl) - An old Discord archival tool written in Golang. It is more developed and seeks to acheive the same goals as this repo.